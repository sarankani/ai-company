...
roles:
  ...
  # Approver seats for engineering, product-design, and operations were
  # handed to saravanan-p on 2026-07-13 (people-gated, founder-approved).
  # Founder remains deputy + head there as the escalation backstop.
...
# Saravanan Pitchaikani — Founder / CEO / Human Operator

Founder-Operator and CEO terminal backstop. Since 2026-07-13, the Approver seats for **Engineering, Product & Design, and Operations** are held by `saravanan-p`; the founder remains Deputy + Head in those departments and holds all seats elsewhere. Seat handovers are people-gated and recorded here as `roles` changes (history via git).
